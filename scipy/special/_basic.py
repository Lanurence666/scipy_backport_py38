...
from . import _ufuncs
from . import _special_ufuncs

def _get_special(name):
    return getattr(_special_ufuncs, name, getattr(_ufuncs, name, None))

mathieu_a = _get_special('mathieu_a')
mathieu_b = _get_special('mathieu_b')
iv = _get_special('iv')
jv = _get_special('jv')
gamma = _get_special('gamma')
rgamma = _get_special('rgamma')
psi = _get_special('psi')
hankel1 = _get_special('hankel1')
hankel2 = _get_special('hankel2')
yv = _get_special('yv')
kv = _get_special('kv')
poch = _get_special('poch')
binom = _get_special('binom')
_stirling2_inexact = _get_special('_stirling2_inexact')

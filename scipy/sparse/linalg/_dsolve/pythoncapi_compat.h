...
#ifndef PYTHONCAPI_COMPAT_SCIPY_SPARSE_DSOLVE
#define PYTHONCAPI_COMPAT_SCIPY_SPARSE_DSOLVE
...
// PyType_GetSlot() - already exists since Python 3.4
// Skip redefinition to avoid static/non-static declaration conflict
#if 0
#include <stdint.h>
#include <stddef.h>
...
// Already defined at the top of this file, skip redefinition
#if 0
static inline PyObject* PyType_GetModule(PyTypeObject *type)
{
    if (type == NULL) {
...
// PyModule_AddFunctions() - already exists since Python 3.8
#if 0
...
// PyInterpreterState_GetDict() - already exists since Python 3.8
#if 0
...
// PyErr_GetExcInfo() / PyErr_SetExcInfo() - already exist since Python 3.8
#if 0
...
#endif  // PYTHONCAPI_COMPAT_SCIPY_SPARSE_DSOLVE
